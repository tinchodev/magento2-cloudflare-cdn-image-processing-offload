...
namespace Nx6\CloudFlare\Block\Product;

use Nx6\CloudFlare\Helper\Image;
use Nx6\CloudFlare\Model\Config;
...
class ImageFactory extends ParentImageFactory
{
    ...
    public function create(Product $product, string $imageId, array $attributes = null): ImageBlock
    {
        ...
        $data = [
            'data' => [
                'template' => 'Nx6_CloudFlare::catalog/product/image_with_borders.phtml',
